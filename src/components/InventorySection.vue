          ...
          <div class="inventory-header">
            ...
            <div class="controls-container">
              <div class="pagination-controls">
                <button class="pagination-btn" @click="updatePage(currentPage - 1)" :disabled="currentPage === 1">
                ...
                <button class="pagination-btn" @click="updatePage(currentPage + 1)" :disabled="currentPage === 3">
                  Próximo
                  <svg width="6" height="12" viewBox="0 0 6 12" fill="none">
